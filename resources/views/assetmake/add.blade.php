...
<section class="tables-data">
	...
	<div class="">
      ...
      <form method="post" action="{{route('assetmake.insert')}}" role="form">
			...
			<tr class="box-section">
				<td width="50%">
					<div class="form-group">
						...
						<input type="text" name="Make" id="Make" placeholder="Asset Make Name" style="border:thin #ede solid;	width:93%;	padding:5px;	border-radius:2px;margin:auto 2% auto 4%; color:#999"  Required onblur="convert_name()"> 
					</div>
