...
<div class="main-content row" autoscroll="true" bs-affix-target="" init-ripples bg="" style="margin-top:-100px">
  <section class="tables-data">
	...
	<div class="">
      ...
      <form class="form-horizontal" method="post" action="{{ url('/role/update', array($role->RoleId)) }}">	
			...
			<tr class="box-section">
				<td width="50%">
					<div class="form-group">
						...
						<input type="text" name="RoleName" id="RoleName" style="border:thin #ede solid;	width:93%;	padding:5px;	border-radius:2px;margin:auto 2% auto 4%; color:#999" value="{{$role->RoleName}}" Required onblur="convert_name()"> 
					</div>
