...
<div class="main-content row" autoscroll="true" bs-affix-target="" init-ripples bg="" style="margin-top:-100px">
  <section class="tables-data">
	...
	<div class="">
      ...
      <form class="form-horizontal" method="post" action="{{ url('/workshop/update', array($workshop->WorkShopId)) }}">
      <LEGEND> Edit Auto Workshop </LEGEND>
        @if(count($errors) > 0)
		...
		<CAPTION>Workshop Details</CAPTION>
			<tr class="box-section">
				<td width="50%">
					<div class="form-group">
						...
						<input type="text" name="WorkShopName" id="WorkShopName" style="border:thin #ede solid;	width:91%;	padding:5px;	border-radius:2px;margin:auto 2% auto 4%; color:#999"@if($workshop) value="{{$workshop->WorkShopName}}"@endif Required onkeyup="convert_name()"> 
					</div>
					
					<div class="form-group">
						<label for="Phone" class="control-label label-left"><i class="fa fa-phone" aria-hidden="true"></i> Phone Number</label>
						<input type="text" name="Phone" id="Phone" style="border:thin #ede solid;	width:91%;	padding:5px;	border-radius:2px;margin:auto 2% auto 4%; color:#999"@if($workshop) value="{{$workshop->Phone}}"@endif Required> 
					</div>
			  </td>
				<td width="50%"> 
					<div class="form-group">
						<label for="ContactName" class="control-label label-right"><i class="fa fa-user" aria-hidden="true"></i> Contact Name</label>
						<input type="text" name="ContactName" id="ContactName" style="border:thin #ede solid;	width:95%;	padding:5px;  border-radius:2px;margin:auto 0% auto 1%; color:#999"@if($workshop) value="{{$workshop->ContactName}}"@endif Required> 
					</div> 
					
					<div class="form-group">
						<label for="Email" class="control-label label-right"><i class="fa fa-envelope" aria-hidden="true"></i> Email</label>
						<input type="email" name="Email" id="Email" style="border:thin #ede solid;	width:95%;	padding:5px;  border-radius:2px;margin:auto 0% auto 1%; color:#999"@if($workshop) value="{{$workshop->Email}}"@endif Required> 
					</div>
				</td>
			...
			<tr class="box-section">
				<td colspan="2">
					<div class="form-group">
						...
						<input type="text" name="Address" id="Address" style="border:thin #ede solid;	width:96%;	padding:5px;	border-radius:2px;margin:auto 2% auto 2%; color:#999"@if($workshop) value="{{$workshop->Address}}"@endif Required onkeyup="convert_addr()">
					</div>
					<input type="hidden" name="CreatedBy" id="CreatedBy" class="form-control" value="{{$workshop->CreatedBy}}" readonly> 
			...
			<tr class="box-section">
				<td width="50%">
					<div class="form-group">
						...
						<input type="text" name="City" id="City" style="border:thin #ede solid;	width:91%;	padding:5px;	border-radius:2px;margin:auto 2% auto 4%; color:#999"@if($workshop) value="{{$workshop->City}}"@endif Required onkeyup="convert_city()"> 
					</div>
					...
					<div class="form-group">
						...
						@if($workshop)
						<option value="{{{ $workshop->Country }}}"> {{ $workshop->Country}} </option>
						@endif
				...
				<td width="50%"> 
					<div class="form-group">
						...
						<input type="text" name="State" id="State" style="border:thin #ede solid;	width:95%;	padding:5px;  border-radius:2px;margin:auto 0% auto 1%; color:#999"@if($workshop) value="{{$workshop->State}}"@endif Require onkeyup="convert_state()"> 
					</div>
					...
					<div class="form-group">
						...
						<select class="sel-opt-right" name="UserId" id="UserId" required>
							<?php								
								$wuid = $workshop->UserId;
								$User = DB::table('users')->where('UserId', '=', $wuid)->first();
							?>
							@if($User)
			...
			<tr class="box-section">
				<td width="50%">
					<div class="form-group">
						<label for="OperationHoursFrom" class="control-label label-left"><i class="fa fa-hourglass-3"></i> Opens From</label>
						<input type="text" class="timepicker" name="OperationHoursFrom" id="OperationHoursFrom" placeholder="HH:MM" style="border:thin #ede solid;	width:91%;	padding:5px;	border-radius:2px;margin:auto 2% auto 4%; color:#999"
						@if($workshop) value="{{$workshop->OperationHoursFrom}}"@endif Required> 
					</div>		
			   </td>
				<td width="50%"> 
					<div class="form-group">
						<label for="OperationHoursTo" class="control-label label-right"><i class="fa fa-hourglass-3"></i> Closes At </label>
						<input type="text" class="timepicker" name="OperationHoursTo" id="OperationHoursTo" placeholder="HH:MM" style="border:thin #ede solid;	width:95%;	padding:5px;  border-radius:2px;margin:auto 0% auto 1%; color:#999"
						@if($workshop) value="{{$workshop->OperationHoursTo}}"@endif Required> 
					</div>
				</td>
