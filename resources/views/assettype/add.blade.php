...
<section class="tables-data">
	...
	<div class="">
      ...
      <form method="post" action="{{route('assettype.insert')}}" role="form">
		...
		<CAPTION>Type Details</CAPTION>
			<tr class="box-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="AssetTypeName" id="AssetTypeName" placeholder="Asset Type Name" style="border:thin #ede solid;	width:93%;	padding:5px;	border-radius:2px;margin:auto 2% auto 4%; color:#999"  Required onblur="convert_type()"> 
                </div>
