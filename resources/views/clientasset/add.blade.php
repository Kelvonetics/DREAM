  ...
  <section class="forms-basic">
	<div class="page-header">
	  <h1>      <i class="fa fa-car"></i>      Client Asset Management   </h1>
		<p  class="lead"> The Client Asset Management module  allows you to efficiently manage your entire asset lifecycle.                      
			<br>With real-time visibility into assetperformance and powerful analytics, it’s easier to ultimately maximize your return on assets (ROA). </p>
	</div>
	  ...
	  <div class="col-md-9 col-md-pull-3 left-side well white" style="margin:-28px 0px 0px 10px">   
		...
		<form method="post" action="{{route('clientasset.insert')}}" role="form">
			<fieldset>
				...
				<CAPTION>Primary Details</CAPTION>
							...
							<div class="form-group">
								<div class="controls">  <label for="ModelId" class="control-label label-right" required> <i class="fa fa-car"></i> Vehicle Model</label>
									<select class='sel-opt-right' name='ModelId' id='ModelId' style="margin:auto 2%;" required>
										<option value=""> Pick A Vehicle Make First </option>
					...
					<tr class="box-section">
						<td> 
							...
							<select class='sel-opt' name='ClientId' id='ClientId' style="margin:auto 2%;" required>
						...
						<td> 
							<div class="form-group"> <label for="Active" style="margin-left:15px"> <i class="fa fa-toggle-on"></i> Make Active </label>
								<div class="radio" style="margin-left:-10px">
								
									<table width="40%" style="margin-left:25px">
									  <tr>
					...
					<tr>
						<td> 
							<div class="form-group">
								<button type="submit" class="btn btn-primary">Create Client Asset</button>
