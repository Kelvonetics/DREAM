...
<div class="main-content row" autoscroll="true" bs-affix-target="" init-ripples bg="" style="margin-top:-100px">
  <section class="tables-data">
	...
	<div class="">
      ...
      <form method="post" action="{{route('userposition.insert')}}" role="form">
			...
			<tr class="box-section">
				<td width="50%">
					<div class="form-group">
						...
						<input type="text" rows="2" name="PositionName" id="PositionName" placeholder="User Position" style="border:thin #ede solid;	width:97%;	padding:5px;	border-radius:2px;margin:auto 3% auto 3%; color:#999" Required onblur="convert_name()"> 
					</div>
				...
				<td width="50%"> 
					<div class="form-group">
						...
						<textarea type="text" name="PositionDesc" id="PositionDesc" style="border:thin #ede solid;	width:93%;	padding:5px;	border-radius:2px;margin:auto 3% auto 3%; color:#999" onblur="convert_desc()" required></textarea>
					</div> 
				</td>
