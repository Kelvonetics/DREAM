...
<div class="main-content row" autoscroll="true" bs-affix-target="" init-ripples bg="" style="margin-top:-100px">
  <section class="tables-data">
	...
	<h1>      <i class="fa fa-bank"></i>  User Department </h1> 
     <p class="lead"> The department module  allows you to efficiently manage your entire department.</p>  <br>
	 <a href="{{route('department.add')}}" class='btn btn-primary' style='font-size:11px;color:white' title='Create New Department For Users'>New Department</a>  
	</div>
    ...
    <table id="example" class="table table-full table-full-small dept" cellspacing="0" width="100%">
        <thead>
            <tr>
				<th> Department Id </th>
				<th> Department </th>
		...
		@if($departments) 
            ...
            <tr>
                ...
                <a href="{{route('department.edit', $departments->DeptId)}}" class='btn btn-info fa fa-edit' style='color:white; font-size:9px'></a>								
