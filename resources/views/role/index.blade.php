...
<div class="main-content row" autoscroll="true" bs-affix-target="" init-ripples bg="" style="margin-top:-100px">
  <section class="tables-data">
    ...
    <a href="{{route('role.add')}}" class='btn btn-primary' style='font-size:11px;color:white' title='Create New Role For Users'>New Role</a>
	</div>
    ...
    <table id="example" class="table table-full table-full-small role" cellspacing="0" width="100%">
        <thead>
            <tr>
				<th> Role Id </th>
				<th> Role </th>
		...
		@if($roles)
            ...
            <tr>
				...
				<td class="actions pull-right">
					...
					<a href="{{route('role.edit', $roles->RoleId)}}" class='btn btn-info fa fa-edit' style='color:white; font-size:9px'></a>								
					<!-- FOR PERMISSION -->
					<a href="{{route('role.permission', $roles->RoleId)}}">&nbsp;&nbsp;&nbsp;<i class="fa fa-pencil"></i></a>	
