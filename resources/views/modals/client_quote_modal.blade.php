...
<div class="" style=""> 
        ...
        ?>
		  ...
		  <div class="form-group">
			<input type ='hidden' name="WorkOrderNumber" id="" class='form-control' placeholder='WorkOrder No' value="{{$total_WO}}" Required readonly />
		  </div> 
			...
			<tr class="box-section">
				<td width="50%">
					...
					?>
						...
						<select class='sel-opt-left' name='ClientId' id='ClientId' required style="border:thin #ede solid;	width:93%;	padding:7.5px;	border-radius:4px; margin:auto 2% auto 4%; color:#999">
						@if($Client)
