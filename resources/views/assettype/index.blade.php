...
<section class="tables-data">
    ...
    <p class="lead"> The vehicle type module  allows you to efficiently manage your entire vehicle type. </p>  <br>
	 <a href="{{route('assettype.add')}}" class='btn btn-primary' style='font-size:11px;color:white' title='Create New Type For Asset'>New Type</a>
...
<div class="col-md-3 col-md-push-9 left-side" style="margin:-50px -20px 0px 10px; background-color:#F9F9F9">
	  ...
	  <div>
        ...
        <table id="example" class="table table-full table-full-small type" cellspacing="0" width="100%">
        <thead>
            <tr>
                <th> Asset Type Id </th>
		...
		@if($assettypes)
            ...
            <tr>
                <td>{{$assettypes->AssetTypeId}}</td>
                <td>{{$assettypes->AssetTypeName}}</td>

                <td class="actions pull-right">					
                <a href="{{route('assettype.edit', $assettypes->AssetTypeId)}}" class='btn btn-info fa fa-edit' style='color:white; font-size:9px'></a>	 
                </td>
            </tr>
            @endforeach
		@endif
