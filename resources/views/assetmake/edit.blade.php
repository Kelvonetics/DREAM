...
<section class="tables-data">
	...
	<h1>      <i class="fa fa-car"></i>     Vehicle Make </h1> 
	<p class="lead"> The vehicle make module  allows you to efficiently manage your entire vehicle make. </p>
	</div>
	...
	<div class="">
      ...
      <form class="form-horizontal" method="post" action="{{ url('/assetmake/update', array($assetmake->MakeId)) }}">
		...
		<CAPTION>Make Details</CAPTION>
			<tr class="box-section">
				<td width="50%">
					<div class="form-group">
						<label for="Make" class="control-label label-left"><i class="fa fa-car"></i> Make Name</label>
						<input type="text" name="Make" id="Make" placeholder="Asset Make Name" style="border:thin #ede solid;	width:93%;	padding:5px;	border-radius:2px;margin:auto 2% auto 4%; color:#999"  value="{{$assetmake->Make}}" Required onblur="convert_name()"> 
					</div>
					<input type="hidden" name="CreatedBy" id="CreatedBy" class="form-control"@if($assetmake) value="{{$assetmake->CreatedBy}}"@endif readonly >
			...
			<td colspan="2">
				<div class="form-group" style="margin-left:-6px">
					<button type="submit" class="btn btn-primary">Update Vehicle Make</button>
...
<script>
	function convert_make() 
	{
		var str = document.getElementById('Make').value;
	   ...
	   var cap = splitStr.join(' '); 
			document.getElementById('Make').value = cap;
	}
</script>
