...
<div class="main-content row" autoscroll="true" bs-affix-target="" init-ripples bg="" style="margin-top:-100px">
  <section class="tables-data">
	...
	<h1>      <i class="fa fa-sitemap"></i>     User Position  </h1> 
	 <p class="lead"> The user position module  allows you to efficiently manage your entire user position. </p> <br>
     <a href="{{route('userposition.add')}}" class='btn btn-primary' style='font-size:10px;color:white' title='Create New Position For Users'>New Position</a>
	</div>
    ...
    <table id="example" class="table table-full table-full-small post" cellspacing="0" width="100%">
		...
		@if($userpositions)
            ...
            <tr>
				<td>{{$userpositions->PositionId}}</td>
				<td>{{$userpositions->PositionName}}</td>
				<td>{{$userpositions->PositionDesc}}</td>
				<td class="actions pull-right">
				
                <a href="{{route('userposition.edit', $userpositions->PositionId)}}" class='btn btn-info fa fa-edit' style='color:white; font-size:9px'></a>								
