...
<section class="tables-data">
	...
	<h1>      <i class="fa fa-car"></i>     Asset Make </h1> 
            <p class="lead"> The Asset Make module  allows you to efficiently manage your entire asset Make. </p>  <br>
	 <a href="{{route('assetmake.add')}}" class='btn btn-primary' style='font-size:11px;color:white' title='Create New Make For Asset'>New Make</a>
...
<div class="col-md-3 col-md-push-9 left-side" style="margin:-50px -20px 0px 10px; background-color:#F9F9F9">
	  ...
	  <div>
        ...
        <table id="example" class="table table-full table-full-small make" cellspacing="0" width="100%">
        <thead>
            <tr>
                <th> Make Id </th>
                <th> Vehicle Make </th>
		...
		@if($assetmakes)
            ...
            <tr>
                <td>{{$assetmakes->MakeId}}</td>
                <td>{{$assetmakes->Make}}</td>

                <td class="actions pull-right">					
                <a href="{{route('assetmake.edit', $assetmakes->MakeId)}}" class='btn btn-info fa fa-edit' style='color:white; font-size:9px'></a>	 
                </td>
            </tr>
            @endforeach
		@endif
