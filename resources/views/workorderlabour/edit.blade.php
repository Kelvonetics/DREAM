...
<section class="tables-data">
	...
	<div class="">
      ...
      <form class="form-horizontal" method="post" action="{{ url('/workorderlabour/update', array($workorderlabour->LabourId)) }}">
      <LEGEND> Edit Labour </LEGEND>
        @if(count($errors) > 0)
		...
		<CAPTION>Labour Details</CAPTION>
			<tr class="box-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="LabourType" id="LabourType" placeholder="Order Labour Type" style="border:thin #ede solid;	width:93%;	padding:5px;	border-radius:2px;margin:auto 2% auto 4%; color:#999"
					@if($workorderlabour) value="{{$workorderlabour->LabourType}}"@endif Required onblur="convert_type()"> 
                </div>
                <input type="hidden" name="CreatedBy" id="CreatedBy" class="form-control" value="{{$workorderlabour->CreatedBy}}" readonly >
				...
				<td width="50%"> 
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="LabourCost" id="LabourCost" placeholder="Order Labour Cost" style="border:thin #ede solid;	width:93%;	padding:5px; border-radius:2px;margin:auto 0% auto 3%; color:#999"
						@if($workorderlabour) value="{{$workorderlabour->LabourCost}}"@endif Required onblur="convert_cate()"> 
                    </div>
					</div>
            ...
            <td colspan="2">
                <div class="form-group">
                    ...
                    <textarea name="LabourDesc" id="LabourDesc" style="border:thin #ede solid;	width:96%;	padding:5px;	border-radius:2px;margin:auto 2%; color:#999" Required onkeyup="convert_desc()">@if($workorderlabour){{$workorderlabour->LabourDesc}}@endif</textarea> 
                </div> 							
            </td>
        </tr>
