...
<section class="tables-data">
	...
	<div class="">
      ...
      <form method="post" action="{{route('vendor.insert')}}" role="form">
      <LEGEND> New Part Vendor </LEGEND>
			...
			<tr class="box-section">
				...
				<td width="50%"> 
                    <div class="form-group">
                        ...
                        <input type="text" name="VendorName" id="VendorName" placeholder="Vendor Name" style="border:thin #ede solid;	width:94%;	padding:2px 5px;	border-radius:2px;margin:auto 0% auto 3%; color:#999"  Required onblur="convert_vendor()"> 
                    </div>
