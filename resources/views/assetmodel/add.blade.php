...
<section class="tables-data">
	...
	<div class="">
      ...
      <form method="post" action="{{route('assetmodel.insert')}}" role="form">
      <LEGEND> New Vehicle Model </LEGEND>
			...
			<tr class="box-section">
				...
				<td width="50%"> 
                    <div class="form-group">
                        ...
                        <input type="text" name="ModelName" id="ModelName" placeholder="Asset Model Name" style="border:thin #ede solid;	width:93%;	padding:2px 5px;	border-radius:2px;margin:auto 0% auto 3%; color:#999"  Required onblur="convert_model()"> 
                    </div>
