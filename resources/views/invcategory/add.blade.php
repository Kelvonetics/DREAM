...
<section class="tables-data">
	...
	<div class="">
      ...
      <form method="post" action="{{route('invcategory.insert')}}" role="form">
      <LEGEND> New Inventory Category </LEGEND>
		...
		<CAPTION>Category Details</CAPTION>
			<tr class="box-section">
                ...
                <input type="text" name="InvName" id="InvName" placeholder="Inventory Category Name" style="border:thin #ede solid;	width:93%;	padding:5px;	border-radius:2px;margin:auto 2% auto 4%; color:#999"  Required onblur="convert_cate()"> 
            </div>
